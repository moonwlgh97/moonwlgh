...
const Landing = ()=>{
  ...
  return (
    <div className="Landing">
      ...
      <p>알아요, 누구나 흡연이 건강에 안 좋다는 것을 머리로는 알지만 참 참기 힘들다는 것을,<br/>
        하지만, 함께라면 이겨낼 수 있지 않을까요?<br/>
        우리 오늘부터, 함께 금연 생활을 시작해 봐요<br/>
      </p>
     ...
     {/* Login */}
      <Modal isOpen={LoginisOpen} onClose={LoginonClose} isCentered >
        ...
        <ModalContent width="sm" p={5} mx="auto" my="auto">
          ...
          <ModalCloseButton />
          <ModalBody>
           <Image src='/logo.png' alt='Logo' mx="auto" my={4} boxSize="70%"/>
            <VStack spacing={4}>
              <Text mb={3}>소셜 ID로 시작하기</Text>
              <Button colorScheme="yellow" size="md" w="full"
          ...
          <ModalBody>
           <Image src='/logo.png' alt='Logo' mx="auto" my={4} boxSize="70%"/>
            <VStack spacing={4}>
              ...
              <FormControl>
                <Input mb={3} placeholder='이름' />
                <Input mb={3} placeholder='이메일' />
                <Input mb={3} placeholder='생년월일' />
